...
def test_create_points():
    """
    Note: 'test_gdf.shp' test asset is generated by running
    Three_Rivers_Michigan_USA_line.zip through main() and saving
    out the data in its state before create_points() is called.
    """
    test_df = gpd.read_file("tests/assets/test_gdf.shp").head()
